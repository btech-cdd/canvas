(async function () {
  ...
  if (window.self === window.top) { //Make sure this is only run on main page, and not every single iframe on the page. For example, Kaltura videos all load in a Canvas iframe
    ...
    */
    ...
    await $.getScript("https://btech-cdd.github.io/custom_features/editor_toolbar/toolbar.js");
    if (COURSE_LIST === undefined) {
      await $.getScript("https://btech-cdd.github.io/course_data/course_list.js");
    }
    if (COURSE_HOURS === undefined) {
      await $.getScript("https://btech-cdd.github.io/course_data/course_hours.js");
    }
    //GENERAL FEATURES
    if (!IS_TEACHER) {
