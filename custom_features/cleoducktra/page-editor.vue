  ...
  <div>
    ...
    >
      ...
      <div
        ...
        <button @click="contentType = 'Clarity'; state = 'course';" class="msger-btn">Course</button>
        <button @click="contentType = 'Spelling/Grammar'; state = 'course'" class="msger-btn">Module</button>
        <button @click="contentType = 'Concision'; state = 'course'" class="msger-btn">Page</button>
      </div>
    </div>
    <div
      style="height: auto;"
