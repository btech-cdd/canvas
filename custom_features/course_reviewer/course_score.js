    ...
    let el = $(`
      <div style="padding: 8px 0;">
       <h2>Quiz Review</h2>
        ...
        <div title="The assignment explicitly states how this students will receive documented feedback.">
          <span style="width: 5rem; display: inline-block;">Instructions</span><span>${ emojiInstructions }%</span>
        </div>
        <div title="The assignment explicitly states how this students will receive documented feedback.">
          <span style="width: 5rem; display: inline-block;">Preparation</span><span>${ emojiPreparation }%</span>
        </div>
      </div> 
      `);
    return el;
