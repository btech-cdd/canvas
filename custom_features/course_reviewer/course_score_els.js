    ...
    <div v-if="view == 'main'">
      <div class="btech-course-evaluator-content-box">
        ...
        <div v-for="(objective, o) in objectivesData" :key="o">
          <span 
            style="display: inline-block; width: 4rem;"><div style="position: relative; width: 1rem; height: 1rem; border-radius: 50%;" 
            :style="{
          ...
          ></div></span><span>{{objective.objective_text.trim()}}</span>
        </div>
