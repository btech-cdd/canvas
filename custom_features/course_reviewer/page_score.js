  ...
  function generateDetailedPageReviewEl() {
    let el = $(`
      <div style="padding: 8px 0;">
        ...
        <div title="The page is alligned to the course objectives.">
          <span style="width: 5rem; display: inline-block;">Allignment</span><span>${ (pageReviewData?.objectives ?? []) > 0 ? emojiTF[1] : emojiTF[0]}</span>
        </div>
