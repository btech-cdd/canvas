(async function () {
  ...
  async function exampleBox() {
    ...
    editor.execCommand("mceReplaceContent", false, `
      <div style="background-color: #ffffff; color: #000000; border: 2px solid ${color}; border-radius: 5px; margin: 1rem auto; width: 70%;" role="note" aria-label="callout-box-with-title">
