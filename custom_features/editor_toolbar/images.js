(async function () {
  ...
  TOOLBAR.addButtonIcon("far fa-exclamation-triangle", "Blur image with graphic content.", function() {blurGraphicImage();resetImgButtons();}, 'btech-img-option btech-graphic-image-option');
