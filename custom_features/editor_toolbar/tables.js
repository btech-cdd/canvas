(async function () {
  ...
  TOOLBAR.addButtonIcon("far fa-file-spreadsheet", "Insert a table which will be linked to a source table on a Canvas page. You will need the page id as it appears in the page URL.", tableFromPage);
