  ...
  function alignCallout() {
      ...
      contents.each(function () {
          ...
          if (contentId) {
              ...
              comment.on( "mouseenter", ()=>{console.log(content); content[0].remove(); content.css({'background-color': highlightColor + ' !important'})}).on( "mouseleave", ()=>{content.css({'background-color': ogBG})});
          }
      });
    return true;
  }
