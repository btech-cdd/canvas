  ...
  function alignCallout() {
      ...
      contents.each(function () {
          ...
          if (contentId) {
              ...
              comment.on( "mouseenter", ()=>{consolee.log(highlightColor); content.css({'background-color': highlightColor + ' !important'})}).on( "mouseleave", ()=>{content.css({'background-color': ogBG})});
          }
      });
    return true;
  }
